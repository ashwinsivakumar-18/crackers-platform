...
const brandingSchema = z.object({ logoUrl: z.string().nullable().optional() });
...
module.exports = {
  ...
  setBranding: async (req, res) => {
    const doc = await Settings.findOneAndUpdate({ key: 'global' }, { $set: { logoUrl: req.body.logoUrl || null } }, { upsert: true, new: true });
